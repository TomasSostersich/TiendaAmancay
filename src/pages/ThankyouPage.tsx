		...
		<div className='flex flex-col h-screen'>
			...
			<main className='container flex-1 flex flex-col items-center gap-10'>
				...
				<div className='border border-slate-200 w-full md:w-[600px] p-5 rounded-md space-y-3'>
					...
					<p className='text-sm'>
						Gracias por realizar tu compra en Amancay Accesorios. Para
					...
					<div className='space-y-0.5 text-sm'>
						<p>Personal Pay</p>
						<p>Razón Social: AmancayAccesorios</p>
						<p>CVU: 123456789000</p>
					...
					<p className='text-sm'>
						...
						comprobante a amancayacces@gmail.com para procesarla
						y hacerte la entrega de tus accesorios a domicilio.
					</p>
				</div>
				...
				<div className='border border-slate-200 w-full p-5 rounded-md space-y-3 md:w-[600px]'>
					...
					<div className='grid grid-cols-2 gap-5'>
						...
						<div className='flex flex-col text-sm'>
							...
							<p>
								Deposito bancario - {(data.totalAmount)}
							</p>
						</div>
