		...
		<div className='flex flex-col gap-6 relative'>
			...
			>
				...
				>
					<InputForm
						type='text'
						placeholder='Ejemplo: Argolla Cubana'
						label='nombre'
						name='name'
						register={register}
						errors={errors}
				...
				<SectionFormProduct>
					<InputForm
						...
						label='Slug'
						name='slug'
						placeholder='Aros argolla cubana ab'
						register={register}
						errors={errors}
					/>
					...
					<InputForm
						...
						required
					/>
					<label className='text-sm font-semibold text-gray-400'> Categorias posibles: 'Anillos','Cadenas','Pulseras','Aros','Collares de Gamuza','Pulseras de hilo'</label>
				</SectionFormProduct>
